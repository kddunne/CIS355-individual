<?php
//Filename: login.php, Kyle Dunne, CIS355, 2015-04-20
//This file allows a user to log in
//Code adapted from Multifile CRUD example done in class
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		$error = '<div class="alert alert-danger" role="alert"><b>Login Error:</b> Please username and password.</div>';
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~kddunne/individual/index.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~kddunne/individual/login.php" )
			{
